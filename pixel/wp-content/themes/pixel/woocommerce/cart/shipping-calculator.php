...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<section class="shipping-calculator-section" style="display:block!important;">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="btn update"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
