...
$content_bg = esc_url (AfterSetupTheme::pranon_return_thme_option('category-single-parallax','url') ) != null ? esc_url (AfterSetupTheme::pranon_return_thme_option('category-single-parallax','url') ) : get_template_directory_uri().'/images/teaserImages/r1.jpg';
?>
